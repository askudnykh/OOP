...
student2 = Student('Anton', 'Skudnyh', 'm')
student2.courses_in_progress += ['Python']

expert1 = Reviewer('Karl','Mane')
expert1.courses_attached.append('Python')
expert2 = Reviewer('Polina','Kuznecova')
...
lector1 = Lecturer('Petr','Petrov')
lector1.courses_attached.append('Python')

lector2 = Lecturer('Andrey','Sidorov')
